<template class="ahmed">
  <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-sm-2">
            ...
            <div class="dropdown-menu">
              ...
              >
              <a class="dropdown-item" href="../forms/logout.php"
    ...
    <div class="row">
      ...
      <div class="col-sm-10" id="demo"></div>
    </div>
  </div>
</template>
...
.box .input-box textarea:focus ~ label,
.box .input-box input:valid ~ label,
.box .input-box textarea:valid ~ label {
  top: -18px;
  left: 0;
  color: #09bcff;
  font-size: 13px;
...
/* Other ............ */
body {
  background-image: url("https://www.shutterstock.com/image-photo/mountains-under-mist-morning-amazing-nature-1725825019");
